...
jQuery(document).ready(function($){
 ...
 myApp.onPageInit('splash', function (page) {
				   ...
				   console.log(number);
				    setTimeout(function(){
 document.getElementById("newimg").src="https://bohicket.saltydog.com/selfie2/src/image-" + number + ".jpg";
    },1000);
	...
	$('iframe').attr('src','https://bohicket.saltydog.com/selfie2/selfie/dev/dl.php?image=https://bohicket.saltydog.com/selfie2/src/image-' + number + '.jpg');
...
$('.discard').on('click',function(e){
	e.preventDefault();     
mainView.router.loadPage('https://bohicket.saltydog.com/selfie2/');
...
document.getElementById("photo").src="https://bohicket.saltydog.com/selfie2/src/image-" + number + ".jpg";
...
function test4(){
	...
	$.ajax({
           type: "POST",
           url: 'https://bohicket.saltydog.com/selfie2/test4.php',
...
function test6(){
	...
	$.ajax({
           type: "POST",
           url: 'https://bohicket.saltydog.com/selfie2/test6.php',
           data: $("#webshot").serialize(), // serializes the form's elements.
           success: function(data)
           {
			 console.log(data);
...
function test2(){
	var url = 'https://bohicket.saltydog.com/selfie2/test2.php';
    var postData = $('#webshot').serialize();
	var message = $('textarea[name=message]').value;
	if ($('.message').val().length === 0 ){
		$('.message').val('No Message');
...
$('.cancel').on('click',function(e){
	e.preventDefault();     
mainView.router.loadPage('https://bohicket.saltydog.com/selfie2/selfie/dev/index.php');
});
jQuery(document).ready(function(){
	$("#webshot").on('click','#submit',function(e)
{
	e.preventDefault();
	mainView.router.loadPage('https://bohicket.saltydog.com/selfie2/selfie/dev/index.php');
    var url = 'https://bohicket.saltydog.com/selfie2/test3.php';
    var postData = $('#webshot').serialize();
    var formURL = url;
    $.ajax({
           type: "POST",
