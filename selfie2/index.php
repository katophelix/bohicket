            ...
            <div class="page-content" style="padding-bottom:144px;">
              ...
              <div class="content-block">
                <div class="content-block-inner">
                 ...
                 <img class="webimg" src="http://admin:bohicket@50.252.151.161:8201/web/mobile.html" style="width:100%;" />
...
<?php echo $temp;?>
    ...
    <!--example.com:1234/pagename.cgi?user=admin&pwd=bohicket-->
     <img  src="http://admin:bohicket@50.252.151.161:8201/web/mobile.html" width="100%"
                  height="auto">
//     <script>
...
function killSession() {
    ...
    xhr.send();
        ...
        audioElement.setAttribute('src', 'https://bohicket.saltydog.com/selfie2/src/shutter.mp3');
