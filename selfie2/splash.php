...
<div class="pages" style="overflow-y:scroll;z-index:1;">
  ...
  You've been Entered! Good Luck!
   ...
   <div style="position:relative;width:100%;height:100%;text-align:center;color:#fff;font-size:30px;">
        ...
        <?php if($image != ''){?>
          <img src="https://bohicket.saltydog.com/selfie2/src/<?php echo $image;?>.jpg" style="width:100%;position:relative;top:0;z-index:9999999;left:0;" />
          <?php }else{?>
...
<a href="https://bohicket.saltydog.com/selfie2/" class="discard button button-big  active color-red" style="margin-top:0px;width:44%;float:left;margin-left:5%;">Discard</a>
