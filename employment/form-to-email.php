...
$email_body = "You have received a new message from: $name.\n
 Their phone number is:  $phone.\n
   ...
   " What areas of employment interest you the most?  Answer:  $job. \n".
    ...
    "Tell us about any skills or hobbies you have that you feel make you a good crew member:  Answer:  $skills. \n".
   " What was your favorite job, volunteer work, class, or extracurricular activity and why?  Answer:  $favorite. \n".
    "Please define great customer service:  Answer:  $book. \n".

    
$to = " tim@saltydog.com";//<== update the email address
