...
$sql = "SELECT * FROM retail_receipts ORDER BY id  ";
...
<header>
  ...
  <div class="container ">
    ...
    <button type="button" class="btn btn-secondary"  >
                                                        <a href="https://saltydog.com/lucky/LuckyRecform/formpage.html" style="color: rgb(4, 4, 51) !important;"> 
                                                        If your receipt number matches one of 
                                                        these receipt numbers 
      ...
      <div class="col-xs-12" style="text-align:center">
        <h1>Salty Dog Retail Receipts</h1>        
      </div>
    </div>
 ...
 <?php foreach($result AS $request): ?>
  <tr>
    ...
    <td><?php echo $request['salesperson']; ?></td>
